...
import '../../controllers/c_signup_ctrl/c_signup_ctrl.dart';
...
class ClientSignupScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final ctrl = Get.put(ClientSignupController());
    return Scaffold(
      appBar: KAppBar(
        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              /// title
              Text(KTexts.clientSignUpTitle, style: Theme.of(context).textTheme.headlineMedium,),
                ...
                child: Column(
                  children: [
                    ...
                    TextFormField(
                      ...
                      decoration: const InputDecoration(labelText: KTexts.email,
