...
import '../../../../../../common/widgets/images/k_circular_image.dart';
import '../../../../../../utils/constants/colors.dart';
import '../../../../../../utils/constants/enums.dart';
import '../../../../../../utils/constants/sizes.dart';
import 'k_rounded_image.dart';

/// Widget for uploading images with optional editing functionality
class KImageUploader extends StatelessWidget {
  const KImageUploader({
    super.key,
    this.image,
      ...
      children: [
        ...
        Positioned(
          ...
          child: KCircularIcon(
            ...
            backgroundColor: KColors.primary.withOpacity(0.9),
          ),
        )
      ],
    );
